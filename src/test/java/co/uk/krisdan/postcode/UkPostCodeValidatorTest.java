...
public class UkPostCodeValidatorTest {
	...
	@Test
	public void testNumDigitsCorrect() {
		
		boolean isCorrect = false;
		
		String postcode = "TF1 6QR";
		
		isCorrect = UkPostCodeValidator.numDigitsCorrect(postcode);
		
		assertEquals(true, isCorrect);
	}

	@Test
	public void testGetOutwardChars() {
		
		boolean charsCorrect = false;
		
		String postcode = "TF10 6QR";
		
		String chars = UkPostCodeValidator.getOutwardChars(postcode);
		
		charsCorrect = (chars.equals("TF"));
		
		assertEquals(true, charsCorrect);
	}

	@Test
	public void testGetOutwardNums() {
		
		boolean numsCorrect = false;
		
		String postcode = "TF10 6QR";
		
		String chars = UkPostCodeValidator.getOutwardNums(postcode);
		
		numsCorrect = (chars.equals("10"));
		
		assertEquals(true, numsCorrect);
	}

	@Test
	public void testGetInwardChars() {

		boolean charsCorrect = false;
		
		String postcode = "TF1 6QR";
		
		String chars = UkPostCodeValidator.getInwardChars(postcode);
		
		charsCorrect = (chars.equals("QR"));
		
		assertEquals(true, charsCorrect);
	}

	@Test
	public void testGetInwardNum() {
		
		boolean numsCorrect = false;
		
		String postcode = "TF10 6QR";
		
		String chars = UkPostCodeValidator.getInwardNum(postcode);
		
		numsCorrect = (chars.equals("6"));
	...
	public void testUnused() {
		...
		String postcode = "QF10 6QR";
		
		unused = UkPostCodeValidator.unused(postcode);
		
		assertEquals(true, unused);
	}

	@Test
	public void testIsForces() {
		
		boolean isForces = false;
		
		String postcode = "BF1 3AA";
		
		isForces = UkPostCodeValidator.isForces(postcode);
		
		assertEquals(true, isForces);
	}
